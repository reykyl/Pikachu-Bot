...
if (stiker) conn.sendFile(m.chat, stiker, 'sticker.webp', `${botname}`,m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: packname, body: `${dev}`, mediaType: 2, sourceUrl: redes, thumbnail: catalogo}}}, { quoted: m })
