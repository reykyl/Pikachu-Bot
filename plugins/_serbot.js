...
⟿ 𝐄𝐬𝐜𝐚𝐧𝐞𝐚 𝐞𝐬𝐭𝐞 𝐂𝐨́𝐝𝐢𝐠𝐨 𝐐𝐑 𝐜𝐨𝐧 𝐨𝐭𝐫𝐨 𝐝𝐢𝐬𝐩𝐨𝐬𝐢𝐭𝐢𝐯𝐨  
𝐨 𝐝𝐞𝐬𝐝𝐞 𝐥𝐚 𝐏𝐂 𝐩𝐚𝐫𝐚 𝐬𝐞𝐫 𝐮𝐧 *𝗦𝘂𝗯-𝗕𝗼𝘁 𝗣𝗶𝗸𝗮𝗰𝗵𝘂 𝗧𝗲𝗺𝗽𝗼𝗿𝗮𝗹*.  

➥ ❶ 𓂃 Toca los tres rayitos en la esquina superior derecha.  
➥ ❷ 𓂃 Entra a *"Dispositivos vinculados"*.  
➥ ❸ 𓂃 Escanea este QR y ⚡¡conéctate al poder eléctrico!  

⚠ 𝐄𝐬𝐭𝐞 𝐜𝐨́𝐝𝐢𝐠𝐨 𝐐𝐑 𝐞𝐱𝐩𝐢𝐫𝐚 𝐞𝐧 ❺❹ 𝐬𝐞𝐠𝐮𝐧𝐝𝐨𝐬.  
🐭 *¡Pikachu te está esperando!* ⚡  
`;
...
⟿ 𝐔𝐬𝐚 𝐞𝐬𝐭𝐞 𝐜𝐨́𝐝𝐢𝐠𝐨 𝐩𝐚𝐫𝐚 𝐬𝐞𝐫 𝐮𝐧 *𝗦𝘂𝗯-𝗕𝗼𝘁 𝗣𝗶𝗸𝗮𝗰𝗵𝘂 𝗧𝗲𝗺𝗽𝗼𝗿𝗮𝗹*. ⚡

➥ ❶ 𓂃 Abre los tres rayitos ⚡ arriba a la derecha.  
➥ ❷ 𓂃 Selecciona *"Dispositivos vinculados"*.  
➥ ❸ 𓂃 Toca *Vincular con el número de teléfono*.  
➥ ❹ 𓂃 Ingresa el código y ¡listo! Ya eres parte del equipo eléctrico.  

⚠ 𝐒𝐢 𝐲𝐚 𝐞𝐬𝐭𝐚́𝐬 𝐞𝐧 𝐨𝐭𝐫𝐚 𝐬𝐞𝐬𝐢𝐨́𝐧,  
𝐬𝐞 𝐫𝐞𝐜𝐨𝐦𝐢𝐞𝐧𝐝𝐚 𝐝𝐞𝐬𝐜𝐨𝐧𝐞𝐜𝐭𝐚𝐫𝐬𝐞 ⚠  
