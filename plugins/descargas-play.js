...
const doc = {
  ...
  mimetype: 'audio/mpeg',
  fileName: `${title}.mp3`,
  fileLength: 999999999, // opcional, tamaño en bytes
  jpegThumbnail: await (await fetch("https://raw.githubusercontent.com/Deylin-Eliac/Pikachu-Bot/refs/heads/main/src/IMG-20250613-WA0194.jpg")).buffer(),
  caption: title
};
